  ...
  return (
    <div className="flex flex-col gap-8">
      <StudioPageHeader
        ...
        action={<StudioButton>Add provenance record</StudioButton>}
      />
      <div className="studio-card">
        <StudioEmptyState
          title="No provenance records yet"
          description="Add the first ownership or condition record when an artwork changes hands or location."
        />
      </div>
    </div>
  );
